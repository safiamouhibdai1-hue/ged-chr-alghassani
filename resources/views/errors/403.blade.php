...
<head>
  ...
  <title>Accès refusé — GED Médicale CHR Al Ghassani</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .error-code {
      ...
      background: linear-gradient(135deg, #E8547A, #534AB7);
    ...
    .error-title {
      font-size: 1.3rem; font-weight: 700; color: #1E2A4A;
      margin-bottom: .75rem;
    }
    .error-desc {
...
<body>
  <div class="error-card">
    ...
    <div class="error-desc">
      ...
      Cette section est réservée aux <strong>administratifs</strong> du CHR Al Ghassani.
    </div>
    <div>
